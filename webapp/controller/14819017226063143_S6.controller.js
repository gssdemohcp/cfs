sap.ui.define(["sap/ui/core/mvc/Controller",
	...
	return BaseController.extend("generated.app.controller.14819017226063143_S6", {
		onInit: function() {
			//###################################### STANDARD CODE ####################################################
			this.oRouter = sap.ui.core.UIComponent.getRouterFor(this);
			this.oRouter.getTarget("14819017226063143_S6").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
			//#########################################################################################################
			...
			var oData = {
				"d": {
					"results": [{
						...
						"Stext": "Sales Document Description"
					}, {
			...
			//================================================
			//Array Data For the Table Open Quotations
			//================================================
			var oJSONModel = new JSONModel(openQuotations);
			this.getView().byId(
					"table")
				.setModel(
					oJSONModel);
		...
		handleClose: function(oEvent) {
			...
			for (var i = 0; i < column_selected.length; i++) {
				if (column_selected[i] === "Sales Document Description") {
		...
		rowCount: function() {
			if (openQuotations.openQuotations.length <= 7) {
				this.getView().byId("table").setVisibleRowCount(openQuotations.openQuotations.length);
			} else {
		...
		//========================
		//Filter by Material No
		//========================
		getTAonly: function() {
			var oFilter = new Filter("Material number", sap.ui.model.FilterOperator.EQ, 'M-111');
