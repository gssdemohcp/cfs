...
], function(BaseController, History, Popover, Button, Filter, JSONModel) {
	"use strict";

	return BaseController.extend("generated.app.controller.14819017477321011_S9", {
		onInit: function() {
			//###################################### STANDARD CODE ####################################################
			this.oRouter = sap.ui.core.UIComponent.getRouterFor(this);
			this.oRouter.getTarget("14819017477321011_S9").attachDisplay(jQuery.proxy(this.handleRouteMatched, this));
			//#########################################################################################################
			...
			//=======================================================
			//Array Data For the Table Sales Doc Blocked for Billing
			//=======================================================
			var oJSONModel = new JSONModel(SalesDocBlockedforBilling);
			this.getView().byId(
					"sap_Responsive_Page_0-content-build_simple_Table-1482138580927")
				.setModel(
					oJSONModel);
		...
		handleClose: function(oEvent) {
			...
			for (var i = 0; i < column_selected.length; i++) {
				if (column_selected[i] === "Sales Document") {
					this.byId("sap_Responsive_Page_0-content-build_simple_Table-1482138580927").getColumns()[1].setVisible(true);
					break;
				} else {
					this.byId("sap_Responsive_Page_0-content-build_simple_Table-1482138580927").getColumns()[1].setVisible(false);
				}
			}
			for (var i = 0; i < column_selected.length; i++) {
				if (column_selected[i] === "Sales Document Type") {
					this.byId("sap_Responsive_Page_0-content-build_simple_Table-1482138580927").getColumns()[2].setVisible(true);
					break;
				} else {
					this.byId("sap_Responsive_Page_0-content-build_simple_Table-1482138580927").getColumns()[2].setVisible(false);
				}
			}
			for (var i = 0; i < column_selected.length; i++) {
				if (column_selected[i] === "Net Value") {
					this.byId("sap_Responsive_Page_0-content-build_simple_Table-1482138580927").getColumns()[3].setVisible(true);
					break;
				} else {
					this.byId("sap_Responsive_Page_0-content-build_simple_Table-1482138580927").getColumns()[3].setVisible(false);
				}
			}
			for (var i = 0; i < column_selected.length; i++) {
				if (column_selected[i] === "Unit") {
					this.byId("sap_Responsive_Page_0-content-build_simple_Table-1482138580927").getColumns()[4].setVisible(true);
					break;
				} else {
					this.byId("sap_Responsive_Page_0-content-build_simple_Table-1482138580927").getColumns()[4].setVisible(false);
				}
			}
			for (var i = 0; i < column_selected.length; i++) {
				if (column_selected[i] === "Created On") {
					this.byId("sap_Responsive_Page_0-content-build_simple_Table-1482138580927").getColumns()[0].setVisible(true);
					break;
				} else {
					this.byId("sap_Responsive_Page_0-content-build_simple_Table-1482138580927").getColumns()[0].setVisible(false);
				}
			}
		},
		//===============================================
		...
		rowCount: function() {
			if (SalesDocBlockedforBilling.SalesDocBlockedforBilling.length <= 7) {
				this.getView().byId("sap_Responsive_Page_0-content-build_simple_Table-1482138580927").setVisibleRowCount(SalesDocBlockedforBilling
					.SalesDocBlockedforBilling.length);
			} else {
				this.getView().byId("sap_Responsive_Page_0-content-build_simple_Table-1482138580927").setVisibleRowCount(7);
			}
		},
		...
		getSelectedIndices: function() {
			var aIndices = this.getView().byId("sap_Responsive_Page_0-content-build_simple_Table-1482138580927").getSelectedIndices();
			var sMsg;
		...
		getContextByIndex: function() {
			var iIndex = this.getView().byId("sap_Responsive_Page_0-content-build_simple_Table-1482138580927").getSelectedIndex();
			var sMsg;
			if (iIndex < 0) {
				sMsg = "no item selected";
			} else {
				sMsg = this.getView().byId("sap_Responsive_Page_0-content-build_simple_Table-1482138580927").getSelectedIndex(iIndex);
			}
			MessageToast.show(sMsg);
		},
		...
		filterGlobally: function(oEvent) {
			...
			// update list binding
			var list = this.getView().byId("sap_Responsive_Page_0-content-build_simple_Table-1482138580927");
		...
		clearSelection: function() {
			this.getView().byId("sap_Responsive_Page_0-content-build_simple_Table-1482138580927").clearSelection();
			var oTable = this.getView().byId("sap_Responsive_Page_0-content-build_simple_Table-1482138580927");
		...
		//========================
		getTAonly: function() {
			var oFilter = new Filter("Document type", sap.ui.model.FilterOperator.EQ, 'Standard Order');
			var oBinding = this.getView().byId("sap_Responsive_Page_0-content-build_simple_Table-1482138580927").getBinding("rows");
